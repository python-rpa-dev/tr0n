...
- **Never push to remote unless explicitly ordered by the user.**
...
1. Discuss ideas in conversation first
2. Document decisions in `concept.md`
3. Commit after explicit user approval
4. Push only on explicit user order
